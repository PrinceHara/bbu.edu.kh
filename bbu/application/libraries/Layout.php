...
class Layout
{
    ...
    private $layout_view;
    private $title = '';
    private $css_list = array(), $js_list = array(), $meta_list = array();
    ...
    function view($view, $data = null, $return = false)
    {
        ...
        foreach ($this->meta_list as $k => $v)
            $data['meta_for_layout'] .= sprintf('<meta name="%s" content="%s">', $k, $v) . "\n";
